...
export const InfoCard = ({
  ...
  return (
    <div className="flex flex-col gap-6 px-4 py-5 xl:w-[320px] 2xl:w-[400px] text-neutral-800 bg-white border-b-[0.5px] border-neutral-400">
      ...
      <div className="flex items-center gap-4">
        <button className="bg-[#3B39D9] rounded text-neutral-200 px-3 py-2 text-center">
          {btnPrimary}
        </button>
        <button className="border-[#3B39D9] border-[1px] rounded bg-white text-[#3B39D9] px-3 py-2 text-center">
          {secondaryBtn}
        </button>
      </div>
    </div>
